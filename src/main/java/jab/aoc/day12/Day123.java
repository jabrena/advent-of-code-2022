...
public class Day123 {
	String filepath = "src/test/resources/day12/data.txt";
	String alphabet = "abcdefghijklmnopqrstuvwxyz";

	public int solvePuzzle1(String fileName) {
		...
		//Create Matrix
		try {
			BufferedReader br = Utils.readFileToBufferedReader(fileName);//new BufferedReader(new FileReader(filepath));
			int i = 0;
			String currentLine;
	...
	public int solvePuzzle2(String fileName) {
		List<List<Integer>> matrix = new ArrayList<>();
